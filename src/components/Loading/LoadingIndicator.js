...
const circles = [
  {
    color: "hsl(180, 29%, 50%)",
    target: [centerX + smCircleOffset, centerY - smCircleOffset],
  },
  {
    color: "hsl(180, 29%, 60%)",
    target: [centerX + smCircleOffset, centerY + smCircleOffset],
  ...
  animates: [
    {
      attrName: "cx",
      begin: collapseBegin,
      values: `${centerX}; ${c.target[0]}`,
    },
    {
      attrName: "cy",
      begin: collapseBegin,
      values: `${centerY}; ${c.target[1]}`,
    },
    {
      attrName: "cx",
      begin: expandBegin,
      values: `${c.target[0]}; ${centerX}`,
    },
    {
      attrName: "cy",
      begin: expandBegin,
      values: `${c.target[1]}; ${centerY}`,
    },
  ],
}));
